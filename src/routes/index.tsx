        ...
        >
          ...
          <div
            ...
            style={{
              ...
              transition:
                "opacity 1.2s ease-out, filter 1.2s ease-out, transform 1.2s ease-out, background-image 0.3s ease-in-out",
            }}
          />
          ...
          <div className="relative z-10 container mx-auto px-8 md:px-12 lg:px-16 xl:px-4">
            <div className="mb-12 text-center">
              <h2
                className={`font-heading mb-4 text-2xl font-bold transition-colors duration-1000 ease-out sm:text-3xl md:text-4xl lg:text-5xl ${
                  hoveredCategory
              ...
              <p
                className={`font-body text-sm transition-colors duration-1000 ease-out sm:text-base md:text-lg ${
                  hoveredCategory
              ...
              {categories.map((category, idx) => {
                ...
                return (
                  <div
                    ...
                    className={`group relative cursor-pointer overflow-hidden rounded-lg px-1 transition-opacity duration-1000 ease-out lg:px-2 ${
                      isOtherHovered
      ...
      >
        ...
        <div className="relative z-10 container mx-auto px-8 md:px-12 lg:px-16 xl:px-8">
          <div className="grid grid-cols-1 items-center gap-8 md:grid-cols-2 md:gap-12">
            {/* Left Side - Boxes */}
            <div
              className="relative flex flex-col items-center justify-center md:ml-8 md:items-start lg:ml-16 xl:ml-24"
