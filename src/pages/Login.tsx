...
const Login = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        title: "Welcome back!",
        description: "You have successfully logged in to SMUnity.",
      });
      navigate('/dashboard');
    } catch (error: any) {
      toast({
    ...
    <div className="min-h-screen flex items-center justify-center bg-smu-light py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  <input
                    ...
                    name="remember-me"
                    type="checkbox"
                    className="h-4 w-4 text-smu-red focus:ring-smu-red border-gray-300 rounded"
                  />
                ...
                <div className="text-sm">
                  <Link
                    to="/forgot-password"
                    className="font-medium text-smu-red hover:text-smu-blue transition-colors"
                  >
        ...
        <Card className="bg-blue-50 border-blue-200">
          <CardHeader>
            <CardTitle className="text-blue-800 text-sm">Demo Accounts</CardTitle>
          ...
          <CardContent className="space-y-2 text-xs">
            <div className="flex justify-between items-center">
              ...
              <span className="font-mono text-blue-600">student@smu.edu.sg / password</span>
            </div>
            <div className="flex justify-between items-center">
              <span className="text-blue-700">CSP Leader:</span>
              <span className="font-mono text-blue-600">leader@smu.edu.sg / password</span>
            </div>
            <div className="flex justify-between items-center">
              <span className="text-blue-700">Admin:</span>
              <span className="font-mono text-blue-600">admin@smu.edu.sg / password</span>
            </div>
          </CardContent>
        </Card>
      </div>
