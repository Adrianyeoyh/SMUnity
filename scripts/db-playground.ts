...
import {
  ...
  user as authUser,
} from "../server/drizzle/schema/auth";
  ...
  await db.transaction(async (tx) => {
    ...
    const projectSeeds = [
      // org1 (3 listings)
      {
        ...
        type: "local",
        description:
          "Join us in cleaning up the beach and preserving marine life.",
        ...
        requiredHours: 4,
        imageUrl:
          "https://images.unsplash.com/photo-1581574200745-77f49a9f4f25",
    ...
    const students = [
      {
        id: "stud1",
        name: "Alice Tan",
        email: "alice.2025@smu.edu.sg",
        entryYear: 2022,
        school: "SCIS",
        skills: ["Communication", "Creativity"],
        interests: ["Kids", "Environment"],
      },
      {
        id: "stud2",
        name: "Ben Lim",
        email: "ben.2024@smu.edu.sg",
        entryYear: 2021,
        school: "LKCSB",
        skills: ["Teaching", "Empathy"],
        interests: ["Education", "Children"],
      },
      {
        id: "stud3",
        name: "Carmen Ong",
        email: "carmen.2026@smu.edu.sg",
        entryYear: 2023,
        school: "SOSS",
        skills: ["Program Design", "Patience"],
        interests: ["Animals", "Community"],
      },
      {
        id: "stud4",
        name: "David Koh",
        email: "david.2025@smu.edu.sg",
        entryYear: 2022,
        school: "SIS",
        skills: ["Coding"],
        interests: ["Environment", "Workshops"],
      },
    ];
    ...
    const apps: AppSeed[] = [
      ...
      {
        studentId: "stud1",
        projectTitle: "Virtual Mentoring Program",
        status: "accepted",
      },
      {
        studentId: "stud2",
      ...
      {
        studentId: "stud3",
        projectTitle: "Animal Shelter Volunteering",
        status: "confirmed",
      },
      {
        studentId: "stud2",
        projectTitle: "Recycling Education Booth",
        status: "withdrawn",
      },
      {
        studentId: "stud4",
        projectTitle: "Career Readiness Workshops",
        status: "accepted",
      },
      {
        studentId: "stud3",
        projectTitle: "Community Pet Adoption Day",
        status: "pending",
      },
    ];
