...
// ---------- MEMBERSHIPS ----------
export const projMemberships = pgTable(
  "project_memberships",
  {
...
export const applications = pgTable(
  "applications",
  {
    ...
    skills: text("skills"),
    comments: text("comments"),
    acknowledgeSchedule: boolean("acknowledge_schedule")
      .notNull()
      .default(false),
  ...
  (t) => ({
    uniqOnePerUserPerProject: uniqueIndex("uniq_applicant_project").on(
      t.projectId,
      t.userId,
    ),
